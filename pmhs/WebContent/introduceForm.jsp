...
<br>
   <div id="back">
      ...
      <img width="210px" height="80px" src="img/logo.png">
      <br>
      <img width="210px" height="100px" src="img/introduction.png">
      </div>
      <div class="padding_rightmenu">
      <h2><font size="6px;" color="e50101;">PC Manage Helper System</font>은 고장 PC 및 일반 PC의 통합적인 관리할 수 있는 서비스를 편리하게 제공하고 있습니다.</h2>
    	<br/>
