...
<form action="messageWritePro.msg" method = "POST" enctype="multipart/form=data" name="messageWrite" onsubmit="javascript:return checkit(this)">
	<div id=top>
		<pre><font>메시지 작성   </font></pre>
	</div>
	<br>
	
	<section id=button>
	<input type="image" src="img/messageWrite.jpg">
    ...
    <table id=subject>
   	<tr><td><input type = "text" name = "title" id = "sb_content" maxlength="10" ></td></tr>
   	</table><br>
    ...
    <table id=receiver>
   	<tr>
   		<td><input type = "text" name = "receiver" id = "r_content" /></td>
   	</tr>
    </table><br>
