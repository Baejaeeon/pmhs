...
<script>
	...
	function sit(floor,pcSitNum){
		...
		window.open("errorPCDetail.pca?floor=" + floor + "&pcSitNum=" + pcSitNum,"window1","width=600,height=350");
		//var url = "pcDeclareForm.pc?floor=" + floor + "&pcSitNum=" + pcSitNum;
		//location.href = url;
		//alert(url);
	}
	function reservationMsg(){
		alert("이미 수리 예약이 되어있습니다.");		
	}
...
<form action="pcSelectForm.pc" name="pcSelect" method = "post">
		...
		<tr>
			<td align=center>
				<table BORDER="0">
					<tr>
						<td>
							<h1><span class= "fa fa-bullhorn bigicon"></span>&nbsp;&nbsp;고장 PC 정보</h1><font color="red" size="3px">해당 고장 PC 자리를 클릭해서 고장PC 상세정보를 볼 수 있습니다.</font>
						</td>
					</tr>
				</table>
			</td>
	...
	<table width='750px' border='0' cellspacing='0' cellpadding='0' bbgcolor='#000000'>
		...
		<tr>
			...
			<div class="sit" onclick="<%if(pcSiteList.get(14).getIsReservation() == 1){ %>reservationMsg() <%} else{ %>sit('1','15')<%} %>"id="Layer15" style="position:absolute; left:237.795275590551px; top:129.738219895288px; width:44.8818897637795px; height:32.2513089005236px; z-index:17"><table width=96% height=96% border='1' cellpadding='0' cellspacing='0'><tr><td bgcolor="<%if(pcSiteList.get(14).getIsReservation() == 1){%>blue<%}else if(pcSiteList.get(14).getIsDeclare() == 1){%>red<%} else {%>green<%} %>"  align='center' valign='middle'><font style='color:white;font-size:10pt;font-weight:900;'>15</font></td></tr></table></div>
			<div class="sit" onclick="<%if(pcSiteList.get(15).getIsReservation() == 1){ %>reservationMsg() <%} else{ %>sit('1','16')<%} %>"id="Layer16" style="position:absolute; left:314.173228346457px; top:129.738219895288px; width:44.8818897637795px; height:32.2513089005236px; z-index:12"><table width=96% height=96% border='1' cellpadding='0' cellspacing='0'><tr><td bgcolor="<%if(pcSiteList.get(15).getIsReservation() == 1){%>blue<%}else if(pcSiteList.get(15).getIsDeclare() == 1){%>red<%} else {%>green<%} %>"  align='center' valign='middle'><font style='color:white;font-size:10pt;font-weight:900;'>16</font></td></tr></table></div>
			...
			<div class="sit" onclick="<%if(pcSiteList.get(20).getIsReservation() == 1){ %>reservationMsg() <%} else{ %>sit('1','21')<%} %>"id="Layer21" style="position:absolute; left:237.795275590551px; top:176.649214659686px; width:44.8818897637795px; height:30.7853403141361px; z-index:26"><table width=96% height=96% border='1' cellpadding='0' cellspacing='0'><tr><td bgcolor="<%if(pcSiteList.get(20).getIsReservation() == 1){%>blue<%}else if(pcSiteList.get(20).getIsDeclare() == 1){%>red<%} else {%>green<%} %>" align='center' valign='middle'><font style='color:white;font-size:10pt;font-weight:900;'>21</font></td></tr></table></div>
			<div class="sit" onclick="<%if(pcSiteList.get(21).getIsReservation() == 1){ %>reservationMsg() <%} else{ %>sit('1','22')<%} %>"id="Layer22" style="position:absolute; left:314.173228346457px; top:176.649214659686px; width:44.8818897637795px; height:30.7853403141361px; z-index:27"><table width=96% height=96% border='1' cellpadding='0' cellspacing='0'><tr><td bgcolor="<%if(pcSiteList.get(21).getIsReservation() == 1){%>blue<%}else if(pcSiteList.get(21).getIsDeclare() == 1){%>red<%} else {%>green<%} %>" align='center' valign='middle'><font style='color:white;font-size:10pt;font-weight:900;'>22</font></td></tr></table></div>
			<div class="sit" onclick="<%if(pcSiteList.get(22).getIsReservation() == 1){ %>reservationMsg() <%} else{ %>sit('1','23')<%} %>"id="Layer23" style="position:absolute; left:359.055118110236px; top:176.649214659686px; width:44.8818897637795px; height:30.7853403141361px; z-index:28"><table width=96% height=96% border='1' cellpadding='0' cellspacing='0'><tr><td bgcolor="<%if(pcSiteList.get(22).getIsReservation() == 1){%>blue<%}else if(pcSiteList.get(22).getIsDeclare() == 1){%>red<%} else {%>green<%} %>" align='center' valign='middle'><font style='color:white;font-size:10pt;font-weight:900;'>23</font></td></tr></table></div>
			<div class="sit" onclick="<%if(pcSiteList.get(23).getIsReservation() == 1){ %>reservationMsg() <%} else{ %>sit('1','24')<%} %>"id="Layer24" style="position:absolute; left:435.433070866142px; top:176.649214659686px; width:44.8818897637795px; height:30.7853403141361px; z-index:29"><table width=96% height=96% border='1' cellpadding='0' cellspacing='0'><tr><td bgcolor="<%if(pcSiteList.get(23).getIsReservation() == 1){%>blue<%}else if(pcSiteList.get(23).getIsDeclare() == 1){%>red<%} else {%>green<%} %>" align='center' valign='middle'><font style='color:white;font-size:10pt;font-weight:900;'>24</font></td></tr></table></div>
			<div class="sit" onclick="<%if(pcSiteList.get(24).getIsReservation() == 1){ %>reservationMsg() <%} else{ %>sit('1','25')<%} %>"id="Layer25" style="position:absolute; left:480.314960629921px; top:176.649214659686px; width:44.8818897637795px; height:30.7853403141361px; z-index:30"><table width=96% height=96% border='1' cellpadding='0' cellspacing='0'><tr><td bgcolor="<%if(pcSiteList.get(24).getIsReservation() == 1){%>blue<%}else if(pcSiteList.get(24).getIsDeclare() == 1){%>red<%} else {%>green<%} %>" align='center' valign='middle'><font style='color:white;font-size:10pt;font-weight:900;'>25</font></td></tr></table></div>
			...
			<div class="sit" onclick="<%if(pcSiteList.get(26).getIsReservation() == 1){ %>reservationMsg() <%} else{ %>sit('1','27')<%} %>"id="Layer27" style="position:absolute; left:237.795275590551px; top:208.816753926702px; width:44.8818897637795px; height:32.2513089005236px; z-index:22"><table width=96% height=96% border='1' cellpadding='0' cellspacing='0'><tr><td bgcolor="<%if(pcSiteList.get(26).getIsReservation() == 1){%>blue<%}else if(pcSiteList.get(26).getIsDeclare() == 1){%>red<%} else {%>green<%} %>" align='center' valign='middle'><font style='color:white;font-size:10pt;font-weight:900;'>27</font></td></tr></table></div>
