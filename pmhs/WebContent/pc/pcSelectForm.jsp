...
<body>
 <%ArrayList<LibVO> libSitList = (ArrayList<LibVO>)request.getAttribute("libSitList"); %>
...
<form action="libApplForm.lib" method = "post">
	...
	<a href="pcSelectForm.pc"><input type = "submit" value = "검색" /></a>
	</form>
	<div>
	</div>		
	...
	<table width='750px' border='0' cellspacing='0' cellpadding='0' bbgcolor='#000000'>
		...
		<tr>
			...
			<div class="sit" id="Layer29" style="position:absolute; left:435.433070866142px; top:176.649214659686px; width:44.8818897637795px; height:30.7853403141361px; z-index:29"><table width=96% height=96% border='1' cellpadding='0' cellspacing='0'><tr><td bgcolor='green' align='center' valign='middle'><font style='color:white;font-size:10pt;font-weight:900;'>24</font></td></tr></table></div>
			<div class="sit" id="Layer30" style="position:absolute; left:480.314960629921px; top:176.649214659686px; width:44.8818897637795px; height:30.7853403141361px; z-index:30"><table width=96% height=96% border='1' cellpadding='0' cellspacing='0'><tr><td bgcolor='green' align='center' valign='middle'><font style='color:white;font-size:10pt;font-weight:900;'>25</font></td></tr></table></div>
			<div class="sit" id="Layer31" style="position:absolute; left:192.913385826772px; top:205.816753926702px; width:44.8818897637795px; height:30.7853403141361px; z-index:31"><table width=96% height=96% border='1' cellpadding='0' cellspacing='0'><tr><td bgcolor='green' align='center' valign='middle'><font style='color:white;font-size:10pt;font-weight:900;'>26</font></td></tr></table></div>
			</div>
			<!-- ======================================= MAPTEMP 끝 =====================================-->
			</td>			
		</tr>	
